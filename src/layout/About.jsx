function About() {
    ...
    return (
        ...
        <section id="about" className="h-full sm:h-auto md:h-screen w-full bg-alt-section-bg py-16">
            ...
            <div className="about-container">
                ...
                <div className="content font-body text-sm mt-8">
                    ...
                    <p className="leading-8 mb-8">Hailing from the tropical England and web trained in the beautiful Portland Oregon, USA.  When I’m not exploring new technologies I love to travel the world, watch loud live music, talk politics and go hiking when I can dodge the UK rain.</p>
